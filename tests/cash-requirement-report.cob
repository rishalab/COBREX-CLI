       ...
       PROGRAM-ID. cash-requirement-report.
       ENVIRONMENT DIVISION.
          INPUT-OUTPUT SECTION.
             FILE-CONTROL.
                ...
                SELECT PRINTER-FILE 
                       ASSIGN TO "cash-requirement-report.prn"
       ...
       DATA DIVISION.
          ...
          WORKING-STORAGE SECTION.
                ...
                01 TITLE.
                   ...
                   05 FILLER              PIC X(16) VALUE "CASH REQUIREMENT".
       ...
       PROCEDURE DIVISION.
           ...
           SORT SORT-FILE
            ...
            PERFORM READ-WORK-NEXT-RECORD UNTIL
                                          (WORK-PAID-DATE EQUAL ZEROS AND WORK-SELECTED = "Y")
                                                                    OR
                                                               END-OF-FILE.
